...
Run `python run_ade_analysis.py` to regenerate `dashboard-data.json` with the latest validated EPC data and spatial summaries. The JSON is copied automatically into `dashboard/public/` for the React app and `data/outputs/dashboard/` for archives.

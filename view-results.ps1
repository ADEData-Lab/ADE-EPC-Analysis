# ADE EPC Analysis - View Results Script
# Quick script to open and view national analysis results

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "ADE EPC Analysis - Results Viewer" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path $resultsPath)) {
    ...
    Write-Host "  .\run-conda.ps1  # Windows" -ForegroundColor Gray
    Write-Host "  python run_ade_analysis.py  # Linux/Mac" -ForegroundColor Gray
    exit 1
}
...
switch ($choice) {
    ...
    "4" {
        ...
        if (Test-Path $mapFile) {
            ...
            Write-Host "Ensure spatial dependencies are installed and rerun the pipeline:" -ForegroundColor Yellow
            Write-Host "  .\\run-conda.ps1  # Windows" -ForegroundColor Gray
            Write-Host "  python run_ade_analysis.py  # Linux/Mac" -ForegroundColor Gray
        }
    }
    "5" {
        ...
        if (Test-Path $summaryFile) {
            ...
            Write-Host "Rerun the ADE pipeline to generate reports:" -ForegroundColor Yellow
            Write-Host "  .\\run-conda.ps1  # Windows" -ForegroundColor Gray
            Write-Host "  python run_ade_analysis.py  # Linux/Mac" -ForegroundColor Gray
        }
    }
